<section id="accueil"
    ...
    <div
        ...
        class="absolute top-5 left-[830px] transform -translate-x-1/2
    ...
    <div :class="visible ? 'opacity-90' : 'opacity-0'"
        ...
        <img src="{{ asset('images/hero/hero_section.png') }}" alt="MyMONTO app" class="w-full h-full object-cover">
    </div>

    <div>
        @include('sections.index.navbar')

        <div class="relative flex items-center min-h-[inherit] z-10 mt-7">
            <div class="w-full h-full px-4 sm:px-6 md:px-8 lg:px-[70px]">

                {{-- Version tablette --}}
                <div class="hidden md:grid lg:hidden grid-cols-2 gap-8 items-center py-8 md:py-12 px-4">
                ...
                {{-- Version mobile --}}
                <div class="md:hidden flex flex-col items-center justify-center py-8 text-center space-y-9 px-8">
                    <div class="space-y-4">
                        <h1 :class="visible ? 'anim-visible' : ''"
